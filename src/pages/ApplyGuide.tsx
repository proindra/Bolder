...
<h1 className="text-5xl md:text-7xl font-medium text-white mb-6 tracking-tighter">
                Level Up Your Folders
            </h1>
<p className="text-lg md:text-xl text-white/50 max-w-2xl mx-auto font-light tracking-wide leading-relaxed">
...
{/**/}
<div className="bento-card rounded-2xl p-8 flex flex-col relative group">
...
<p className="text-white/50 font-light leading-relaxed flex-grow">
                    Download your favorite `.ico` file. Save it somewhere safe, like your Documents or a dedicated 'Custom Icons' folder.
                </p>
</div>
{/**/}
<div className="bento-card rounded-2xl p-8 flex flex-col relative group lg:col-span-2">
<div className="flex items-center gap-3 mb-6">
<span className="w-1.5 h-1.5 rounded-full bg-[#4918c8]"></span>
<span className="text-xs font-semibold text-white/50 uppercase tracking-[0.15em]">Step 02</span>
</div>
<div className="flex flex-col md:flex-row gap-8 h-full">
<div className="flex-1 flex flex-col justify-center">
<h3 className="text-3xl font-medium text-white mb-4 tracking-tight">Right-Click &amp; Properties</h3>
<p className="text-white/50 font-light leading-relaxed mb-6">
                            Locate the boring default folder you want to upgrade. Right-click on it and select "Properties" from the bottom of the context menu.
                        </p>
<div className="inline-block bg-white/5 text-white/70 px-3 py-1 rounded font-mono text-xs w-fit border border-white/10 tracking-widest">
                            ALT + ENTER
                        </div>
</div>
...
<p className="text-white/50 font-light leading-relaxed flex-grow">
                    In the Properties window, navigate to the far right tab labeled "Customize". This is where the magic happens.
                </p>
</div>
{/**/}
<div className="bento-card rounded-2xl p-8 flex flex-col relative group">
...
<p className="text-white/50 font-light leading-relaxed flex-grow">
                    Look for the "Folder icons" section at the bottom. Click the shiny button that says "Change Icon...".
                </p>
</div>
{/**/}
<div className="bento-card rounded-2xl p-8 flex flex-col relative group">
...
<p className="text-white/50 font-light leading-relaxed flex-grow">
                    Click "Browse..." to find the `.ico` file you downloaded in Step 1. Select it, and click "OK".
                </p>
</div>
{/**/}
<div className="bento-card rounded-2xl p-8 flex flex-col relative group lg:col-span-3 lg:flex-row items-center gap-12">
<div className="flex-1 text-center lg:text-left">
<div className="flex items-center justify-center lg:justify-start gap-3 mb-6">
<span className="w-1.5 h-1.5 rounded-full bg-primary-container"></span>
<span className="text-xs font-semibold text-white/50 uppercase tracking-[0.15em]">Step 06</span>
</div>
<h3 className="text-3xl md:text-4xl font-medium text-white mb-6 tracking-tight">Apply &amp; Admire</h3>
<p className="text-white/50 font-light leading-relaxed text-lg max-w-xl mx-auto lg:mx-0">
                        Click "Apply" and then "OK" on the Properties window. Boom. Your folder is now a masterpiece. Refresh the desktop if it doesn't show up immediately.
                    </p>
</div>
